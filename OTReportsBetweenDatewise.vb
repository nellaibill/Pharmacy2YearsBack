...
Public Class OTReportsBetweenDatewise

    Private Sub OTReportsBetweenDatewise_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        If drpDoctorName.Text = "All" And rdoBillDate.Checked = True Then
            ...
            Me.DrugSlipDetailsTableAdapter.FillBy3(Me.dsTypewiseReport.DrugSlipDetails, dtpfromDate.Text, dtpToDate.Text)
        ElseIf drpDoctorName.Text <> "All" And rdoBillDate.Checked = True Then
            Me.DrugSlipDetailsTableAdapter.FillBy6(Me.dsTypewiseReport.DrugSlipDetails, dtpfromDate.Text, dtpToDate.Text, drpDoctorName.Text)
        ElseIf drpDoctorName.Text = "All" And rdoIncidentDate.Checked = True Then
            Me.DrugSlipDetailsTableAdapter.FillBy7(Me.dsTypewiseReport.DrugSlipDetails, dtpfromDate.Text, dtpToDate.Text)
        ElseIf drpDoctorName.Text <> "All" And rdoIncidentDate.Checked = True Then
            Me.DrugSlipDetailsTableAdapter.FillBy8(Me.dsTypewiseReport.DrugSlipDetails, dtpfromDate.Text, dtpToDate.Text, drpDoctorName.Text)
        End If
